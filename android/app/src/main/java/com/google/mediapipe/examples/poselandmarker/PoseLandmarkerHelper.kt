...
import com.google.mediapipe.examples.poselandmarker.tracker.ExerciseResult
...
class PoseLandmarkerHelper(
    ...
    fun setupPoseLandmarker() {
        ...
        Log.d("POSE_MODEL", "Using model: $modelName")
    ...
    private fun returnLivestreamResult(
        ...
        // 🟨 Inject test: Check if pose landmarks are available
        val poseLandmarks = result.landmarks().firstOrNull()
        poseLandmarks?.let {
            val analysisResult: ExerciseResult = bicepTracker.analyzePose(it)
            Log.d("BicepDebug", "Reps: ${analysisResult.reps}, Stage: ${analysisResult.stage}, Feedback: ${analysisResult.feedback}")
        }
